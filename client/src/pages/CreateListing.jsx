...
export const CreateListing =()=>{
    ...
    return <div className="p-3 max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
            ...
            <textarea onChange={handleChange} value={formData.description} type="text"  placeholder="Desription" id="description" maxLength='500' minLength='10' required className="border rounded-lg p-3"/>
